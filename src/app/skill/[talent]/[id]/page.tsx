...
import SideBar from "@/components/skill/talent/SideBar";
      ...
      <section className="relative">
        <div className="grid gap-3 mb-3">
          ...
          <Image
            ...
            className="m-auto"
          />
          <p className="w-[450px] m-auto">{findSkill?.description}</p>
        </div>

        <SideBar data={findSkill} />

        <div className="w-[450px] grid gap-3 m-auto">
          {findSkill?.skill_by_rank.map((item, skillIndex) => {
            ...
            // ----------------------------------------------------------------
            return (
              <Card key={skillIndex} className="text-center text-[14px]">
                <CardHeader>
                  <CardTitle id={item.rank} className="font-bold text-[16px]">
