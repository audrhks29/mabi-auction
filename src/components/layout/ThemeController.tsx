...
export default function ThemeController() {
  ...
  return (
    <button type="button" data-key="mabiAuction-theme" data-toggle-theme="dark,light" data-act-class="ACTIVECLASS">
      {theme === "light" && (
      ...
      {theme === null && <LoaderCircle size={40} className="animate-spin" />}
    </button>
  );
}
